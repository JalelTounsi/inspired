...
const CreateOxAPICall = function CreateOxAPICall(chain) {
  ...
  const params = {
    sellToken: sellToken === null ? "ETH" : sellToken, //WETH
...
// async function trySwap(BuyerAddress, BuyTokenAddress, _network) {
//   //the maker of the swap
//   let takerAddress = BuyerAddress; 
//   //the swapParams
//   let SwapQuote = CreateOxAPICall(_network); 
//   //call the ERC20 token's approve() method. Since will need to interact with the ERC20's contract methods
//   const WETHAddress = "0xcd48a86666D2a79e027D82cA6Adf853357c70d02"; // WETH address on goerli
//   BuyTokenAddress = WETHAddress
...
//     address: WETHAddress,
//     abi: erc20ABI,
//     signerOrProvider: BuyerAddress,
//   });
//   // we approve the contract of the buy token
...
export default function TradeTokens0x() {
              ...
              >
                <VStack>
                        ...
                        <Box>
                          <HStack>
                            <IconButton
                              ...
                              onClick={onOpen}
                            />
                            <FormControl isInvalid={input === ''}><Input
                              type="text"
                              name="SellToken"
                              placeholder={tokens[0].symbol}
                        ...
                        <Box>
                          <HStack>
                            ...
                            <Input
                              type="text"
                              name="BuyToken"
                              placeholder={tokens[57].symbol}
                              //value={tokens[57].symbol}
                              id="TokenToBuy"
                              variant={"flushed"}
                              htmlSize={4}
                            />
                  ...
                  <SimpleGrid columns={3} spacing={2}>
                    ...
                    <Box>
                      <Button
                        onClick={() => trySwap(address, _ERC20TokenContract, chain)}
                        colorScheme="red"
                        bg="red.400"
                        color="white"
                        _hover={{
